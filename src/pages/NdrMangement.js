            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <p>
                  ...
                  companies specifying the orders which could not be delivered
                  in a certain timeframe. When a delivery agent is unable to
                  successfully deliver the order, which might happen for a
                  variety of reasons like “incorrect address” or “customer
                ...
                <p>
                  ...
                  by the courier partner to deliver your order to the end
                  customer post which is marked as RTO (Return to Origin), and
                  the shipment is returned to the pickup location
                </p>
              </div>
        ...
        <div className="container-fluid">
          ...
          <div className="row ">
            <div className="col-md-6 step-part ">
              <div className="primum-steps">
                <h2></h2>
                <h5>
                  <span>Stage 1:</span> Identify failed delivery attempts (NDR)
                  in real-time
                </h5>
                <p>
          ...
          <div className="row  mt-4 ">
            <div className="col-md-6 step-part ">
              <div className="primum-steps">
                <h5>
                  <span>Stage 2:</span> Seek response from customers to ensure
                  delivery
                </h5>
                <p>
                  ClickPost has deep API integrations with carriers enabling
          ...
          <div className="row mt-4 ">
            <div className="col-md-6 step-part ">
              <div className="primum-steps">
                <h5>
                  <span>Stage 3:</span> Integrated NDR management portal
                </h5>
                <p>
                  ClickPost has deep API integrations with carriers enabling
                  real-time identification and categorization of NDRs. Data is
              ...
              <div className="row">
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/1.png"
                      alt=""
                      srcset=""
                    />
                    <h5>Wrong address</h5>
                ...
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/2.png"
                      alt=""
                      srcset=""
                    />
                ...
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/3.png"
                      alt=""
                      srcset=""
                    />
                ...
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/4.png"
                      alt=""
                      srcset=""
                    />
                ...
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/5.png"
                      alt=""
                      srcset=""
                    />
                ...
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/6.png"
                      alt=""
                      srcset=""
                    />
                ...
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/7.png"
                      alt=""
                      srcset=""
                    />
                ...
                <div className="col-md-3 col-6">
                  <div className="resons_ndr_card">
                    <img
                      src="/image/Solutionss/ndr/icons/8.png"
                      alt=""
                      srcset=""
                    />
          ...
          <div className="ndr-mangemnet-part">
            <div className="row">
              <div className="col-md-7">
                ...
                <p>
                  Once an NDR happens, you need to take action immediately and
                  not leave it to courier partner Here are 5 ways you can reduce
                  RTO after a failed delivery:
                </p>
          ...
          <div className="row justify-content-center">
            <div className="col-md-8 col-11 ">
              <div className="shiping_now_inside">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Maiores in, quisquam reiciendis, excepturi dolores corporis
                  expedita tenetur laborum non architecto voluptas officia omnis
                  incidunt neque laboriosam enim commodi, voluptatem odit!
                </p>
